...
high_school_musical = media.Movie("High School Musical", "Love stroy of a school boy and girl",
...
dangal = media.Movie("Dangal", "Story of a father who trained his daughters for the Commonwealth Games despite societal pressures.",
...
sairat = media.Movie("Sairat", "Story of College friends Archi and Parshya, who have contrasting personalities and belong to different castes, fall in love. However, their relationship falls prey to the stringent practice of casteism."
                                ,"https://upload.wikimedia.org/wikipedia/en/a/a1/Sairat_Marathi_Film_Poster.jpg",
                                "https://www.youtube.com/watch?v=X8Z73ce9Vbo")
                  
                   
#created 6th movie instance
queen = media.Movie("Queen", "A homely girl who decides to go on her honeymoon alone when her fiance call off the wedding",
                    "https://upload.wikimedia.org/wikipedia/en/4/45/QueenMoviePoster7thMarch.jpg",
                    "https://www.youtube.com/watch?v=KGC6vl3lzf0")                 


#array of movies
movies = [toy_story, high_school_musical, dangal, finding_nemo, sairat, queen]
